...
### Task 1: Scaffold the generated Xcode project and package boundaries
...
### Task 2: Add exact poker value types
...
### Task 3: Model legal actions for a stored cash-game decision
...
### Task 4: Load and validate immutable strategy packs
...
### Task 5: Grade decisions by transparent EV loss
...
### Task 6: Persist immutable local training events
...
### Task 7: Reduce events into an explainable ability profile and daily plan
...
### Task 8: Compose app dependencies and adaptive navigation
...
### Task 9: Implement the decision-session state machine
...
### Task 10: Present professional feedback without hiding uncertainty
...
### Task 11: Connect Today and Review to real local events
...
### Task 12: Add the debug strategy fixture and end-to-end UI coverage
...
### Task 13: Add one-command verification and M1A handoff documentation
